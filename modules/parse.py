...
parser_fetch.add_argument('action', help='action to perform',choices=['fetch','history','update'])
...
parser_fetch.add_argument('--name', help='custom name (you can use {tags}, {start} and {stop})',default='dl_{tags}{start}_{stop}.html')
...
parser_fetch.add_argument('--website', help='website to fetch from',default=0)
